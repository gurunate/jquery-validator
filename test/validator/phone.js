...
describe("Phone Type Field Validation", function() {
	...
	it("phone number should be required and valid [no format]", function() {
	...
	it("phone number should be required and valid [formatted]", function() {
		fixture.append(
	...
	it("phone number should be required and invalid", function() {
		fixture.append(
	...
	it("phone number should NOT be required and is valid (optional)", function() {
		fixture.append(
