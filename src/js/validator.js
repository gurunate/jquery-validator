...
(function($) {'use strict';
    ...
    $.fn.extend({
            ...
            element.find('[data-validator]').each(function(i, el) {
                ...
                $.each(directives, function(i, r) {
                    ...
                    if (r !== 'required') {
                        ...
                        if (textRange.test(r)) {
                            var m = textRange.exec(r), val = $(el).val();
                        ...
                        } else if ((el.isRequired && !_this.isValidType(r, el)) || (_this.isValidValue(el) && !_this.isValidType(r, el))) {
                            _this.errors.push({
        ...
        isValidType : function(type, el) {
            ...
            if ( typeof _this.options !== 'undefined' && typeof _this.options.rules !== 'undefined' && typeof _this.options.rules[type] !== 'undefined') {
